...
<p className="mt-2 text-[#666e75] text-[16px] maxx-w-[500px]">Create imaginative and visually stunnig images Through  DALL-E AI</p>

</div>
    
    <form className="mt-16 max-w-3xl" on sumit={handleSumit}>
